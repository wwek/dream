...
protected:
    ...
    QIODevice*              pIODevice;
#endif
    CSoundInInterface*		pSound;  //when QT_MULTIMEDIA_LIB is open, this is reserved for audiofile handle,otherwise it is handle for both audio file and device 
    ...
    CMutex 			mutexSound;	
    CWaitCondition		waitConditionSound;
    CMutex                  mutexInpData;
